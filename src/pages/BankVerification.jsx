    ...
    return (
        <div>
              <div className="flex justify-between h-[20%] py-[10%] mx-auto w-[90%]">
                <Link to='/register/residency-info'>
                ...
                <div>
                    <span className='text-[14px] text-[#bdbdbd] text'> STEP 03/03</span>
                    <p className='text font-bold text-[16px] text-[#8692ab] '>Bank Verification</p>
                </div>
            </div>
