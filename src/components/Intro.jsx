  ...
  return (
    <div>
       <div className='flex justify-end'>
        <p className='text h-[20%] text-[#8692A6] text-[18px] pt-[10%] pb-[10%] mr-[50px] md:mr-[100px]'>Already have an account? <Link to='/login'><span className='cursor-pointer text-[#1565D8] font-bold'>Sign In</span></Link></p>
       </div>
        <div className='flex pl-[15%] flex-col  mx-auto  md:mt-[40px] '>
            ...
            <div className='card flex items-center w-[80%]  flex-col gap-[20px]'>
                {
                    cardData.map((e,i) => {
                        return(
